...
class NamaOrmawaPimpinan extends E_Controller{
  ...
  function index()
  {
    $namaormawapimpinan = $this->ModelNamaOrmawa->get_data()->result();
    $data = array(
      'body' => 'NamaOrmawaPimpinan/list',
      'namaormawapimpinan' => $namaormawapimpinan
     );
