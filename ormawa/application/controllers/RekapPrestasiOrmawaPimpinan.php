...
class RekapPrestasiOrmawaPimpinan extends E_Controller{
  ...
  function index()
  {
    $rekapprestasiormawapimpinan = $this->ModelDataPrestasiOrmawa->get_data();
    $data = array(
      'body' => 'RekapPrestasiOrmawaPimpinan/list',
      'rekapprestasi' => $rekapprestasiormawapimpinan
     );
  ...
  function data_foto(){
    ...
    if(!empty($cek)){
    $data = array(
      'body' => 'RekapPrestasiOrmawaPimpinan/data_foto',
      'id_prestasi' => $id,
      'data_foto' => $data_foto,
     );
    $this->load->view('index', $data);
    ...
    redirect(base_url()."RekapPrestasiOrmawaPimpinan");
  }
 }
