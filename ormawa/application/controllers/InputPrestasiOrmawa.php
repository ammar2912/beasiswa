...
class InputPrestasiOrmawa extends E_Controller{

  public function __construct()
  {
    parent::__construct();
    $this->load->model("ModelInputPrestasiOrmawa");
  }

  function index()
  {
    $data = array(
      'body' => 'InputPrestasiOrmawa/input',
      'form' => 'InputPrestasiOrmawa/form',
     );
  ...
  function insert(){
    ...
    //     redirect(base_url()."InputPrestasiOrmawa");
    //   }
    //   }
