...
class ProdiPimpinan extends E_Controller{

  public function __construct()
  {
    parent::__construct();
    $this->load->model("ModelProdiPimpinan");
  }

  function index()
  {
    $prodi = $this->ModelProdiPimpinan->get_all()->result();
    $data = array(
      'body' => 'ProdiPimpinan/list',
      'prodi' => $prodi
     );
  ...
  function input()
  {
    ...
    $data = array(
      'body' => 'ProdiPimpinan/input',
      'form' => 'ProdiPimpinan/form',
      'jurusan' => $jurusan,
     );
    $this->load->view('index', $data);
  }
  ...
  function edit()
  {
    ...
    $prodi = $this->ModelProdiPimpinan->get_data_edit($id);
    $jurusan = $this->db->get_where('tb_jurusan', array('status' => 1 ))->result();
    $data = array(
      'body' => 'ProdiPimpinan/edit',
      'form' => 'ProdiPimpinan/form',
      'prodi' => $prodi,
      'jurusan' => $jurusan,
     );
