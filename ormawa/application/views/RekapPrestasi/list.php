    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar Data Prestasi</a>
            <div>
              ...
              <?php $no=1; foreach ($rekapprestasi as $data) {?>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <!-- <a href="<?=$data->lampiran;?>" target="_blank"><button class="btn btn-info btn-sm">Download</button></a> -->
                    </td>
                    <td>
                      <a href="<?php base_url()?>RekapPrestasi/data_foto/<?php echo base64_encode($id_check);?>">
                      <b>
