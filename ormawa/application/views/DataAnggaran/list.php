<?php echo form_open('DataAnggaran/delete');?>
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar Anggaran</a>
            <div>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1; foreach ($dataanggaran as $data) {?>
                    ...
                    <tr>
                        ...
                        <td><b style="font-size:12px"><?php echo rupiah($data->anggaran_awal);?></b></td>
                        <td><b style="font-size:12px"><?php echo rupiah($data->anggaran_terpakai);?></b></td>
                        <td><b style="font-size:12px"><?php echo rupiah($data->anggaran_sisa);?></b></td>
                        <td>Thn. <?php echo $data->periode?></td>
                        <td>
                        <?php
                         if($data->status_anggaran == 1){
                         ?>
                         <!-- <a href="<?php base_url()?>DataAnggaran/NonAktif/<?php echo base64_encode($id_check);?>"> -->
                         <p class="btn btn-success btn-sm">Aktif</p>
                         </a>
                         <?php
                         } else{
                         ?>
                         <!-- <a href="<?php base_url()?>DataAnggaran/Aktif/<?php echo base64_encode($id_check);?>"> -->
                        ...
                        <td>
                          <a href="<?php base_url()?>DataAnggaran/edit/<?php echo base64_encode($id_check);?>">
                          ...
                          <!-- button 1 -->
                          <a onclick="return confirm('Ormawa yang dinonaktifkan tidak dapat diaktifkan kembali. Apakah anda yakin ?');" href="<?php base_url()?>DataAnggaran/NonAktif/<?php echo base64_encode($id_check);?>" >
