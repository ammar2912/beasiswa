    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar History Kegiatan Mahasiswa</a>
            <div>
      ...
      <div class="card-body">
        ...
        <b><i class="fa fa-square" style="color:green"></i> : Status Kegiatan sudah Pencairan.</b>
                ...
                <tbody>
                  <?php $no=1; foreach ($datakegiatan as $data) {?>
                    ...
                    <tr>
                        ...
                        <td>
                          <?php if($data->status_kegiatan == 0 && $data->status_revisi == 0){ ?>
                          <a href="<?php base_url()?>HistoryKegiatanMahasiswa/delete/<?php echo base64_encode($id_check);?>">
                          <!-- <a> -->
                      ...
                      <?php }else if($data->status_kegiatan == 1 || $data->status_kegiatan == 2 || $data->status_kegiatan == 3 || $data->status_kegiatan == 4 || $data->status_kegiatan == 5 || $data->status_kegiatan == 6){ ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="bodymodal_revisi">
        <h5> Kegiatan : <b id="nama_kegiatan"></b></h5>
        <br>
        <?php echo form_open_multipart('HistoryKegiatanMahasiswa/revisikegiatan');?>
        <div class="row">
          <div class="col-lg-12">
