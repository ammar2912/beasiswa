      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1; foreach ($jenissuratpimpinan as $data) {?>
                    ...
                    <tr>
                        ...
                        <td>
                          <?php
                           if($data->status == 1){
                           ?>
                           <a href="<?php base_url()?>JenisSurat/NonAktif/<?php echo base64_encode($id_check);?>">
                           <p class="btn btn-success btn-sm">Aktif</p>
                           </a>
                           <?php
                           } else{
                           ?>
                           <a href="<?php base_url()?>JenisSurat/Aktif/<?php echo base64_encode($id_check);?>">
                        ...
                        <!-- <td><a href="<?php base_url()?>JenisSurat/edit/<?php echo base64_encode($id_check);?>">
