    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar History Prestasi Ormawa</a>
            <div>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
            ...
            <tbody>
              <?php $no=1;
              foreach ($historyprestasiormawa as $data) {?>
                <?php
                ...
                <tr>
                    ...
                    <td>
                      <a href="<?php base_url()?>HistoryPrestasiOrmawa/tambah_foto/<?php echo base64_encode($id_check);?>">
                      <b>
                    ...
                    <td>
                      <?php if ($data->status_prestasi != 1){?>
                      <a onclick="return confirm('Apakah anda yakin ?');" href="<?php base_url()?>HistoryPrestasiOrmawa/delete/<?php echo base64_encode($id_check);?>">
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="bodymodal_detailprestasi">
        ...
        <!-- Nama Ormawa : <b id="nama_mahasiswa"></b><br>
...
function showuserdetail(id)
          {
              $.ajax({
                  type: "post",
                  url: "<?=site_url('');?>HistoryPrestasiOrmawa/detail_lampiran",
                  data: "id="+id,
                  dataType: "html",
