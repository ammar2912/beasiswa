        ...
        <div class="col-lg-12">
          <div class="card card-cascade narrower z-depth-1">
            ...
            <div class="card-body card-block">
              <?php echo form_open_multipart('HistoryPrestasiOrmawa/tambah_foto_proses');?>
              <?php echo @$error;?>
            ...
            <?php } ?>
              ...
              <div class="col-md-12 col-xl-12" >
                ...
                <button type="submit" id="simpan_data" class="btn btn-primary simpan btn-sm pull-right">SIMPAN FOTO</button>
                  <?php } ?>
              <a href="<?=base_url('')?>HistoryPrestasiOrmawa">
              ...
              foreach ($data_foto as $data) {  ?>
                <div class="col-md-4 col-xl-3" style="padding:10px;text-align:center">
                  ...
                  <?php if($status_prestasi != 1){?>
                   <a href="<?=base_url('')?>HistoryPrestasiOrmawa/delete_foto/<?=base64_encode($data->id);?>/<?=base64_encode($id_prestasi);?>">
