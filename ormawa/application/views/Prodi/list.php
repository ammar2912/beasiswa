<!-- <?php echo form_open('Prodi/delete');?> -->
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar Prodi</a>
            <div>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1; foreach ($prodi as $data) {?>
                    ...
                    <tr>
                        ...
                        <td><b><?php echo $data->nama_prodi?></b></td>
                        <td><?php echo $data->nama_jurusan?></td>
                        <td>
                          <?php
                           if($data->status == 1){
                           ?>
                           <a href="<?php base_url()?>Prodi/NonAktif/<?php echo base64_encode($id_check);?>">
                           <p class="btn btn-success btn-sm">Aktif</p>
                           </a>
                           <?php
                           } else{
                           ?>
                           <a href="<?php base_url()?>Prodi/Aktif/<?php echo base64_encode($id_check);?>">
                        ...
                        <td><a href="<?php base_url()?>Prodi/edit/<?php echo base64_encode($id_check);?>">
