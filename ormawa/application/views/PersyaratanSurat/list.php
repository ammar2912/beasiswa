<!-- <?php echo form_open('PersyaratanSurat/delete');?> -->
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Persyaratan Surat</a>
            <div>
              <a href="<?php base_url(); ?>PersyaratanSurat/input" class="float-right">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1;
                  foreach ($persyaratansurat as $data) {?>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="<?php base_url()?>PersyaratanSurat/edit/<?php echo base64_encode($id_check);?>">
                        ...
                        <?php
                         if($data->status == 1){
                         ?>
                         <a onclick="return confirm('Apakah anda yakin ?');" href="<?php echo base_url()?>PersyaratanSurat/NonAktif/<?php echo base64_encode($id_check);?>">
                         ...
                         ?>
                         <a onclick="return confirm('Apakah anda yakin ?');" href="<?php echo base_url()?>PersyaratanSurat/Aktif/<?php echo base64_encode($id_check);?>">
