    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Profil Kemahasiswaan</a>
            <div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 col-xs-6 b-r"> <strong>Nama</strong>
                    <br>
                    <p class="text-muted">Danu</p>
                </div>
                <div class="col-md-3 col-xs-6 b-r"> <strong>Bagian</strong>
                    <br>
                    <p class="text-muted">Kemahasiswaan</p>
                </div>
