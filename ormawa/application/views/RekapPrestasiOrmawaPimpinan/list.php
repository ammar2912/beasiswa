      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
            ...
            <tbody>
              <?php $no=1; foreach ($rekapprestasi as $data) {?>
                <?php
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <!-- <a target="_blank" href="<?=base_url('');?>file/<?=$data->lampiran;?>" ><button class="btn btn-info btn-sm">Download</button></a> -->
                    </td>
                    <td>
                      <a href="<?php base_url()?>RekapPrestasiOrmawaPimpinan/data_foto/<?php echo base64_encode($id_check);?>">
                      <b>
...
function showuserdetail(id)
          {
              $.ajax({
                  type: "post",
                  url: "<?=site_url('');?>RekapPrestasi/detail_lampiran",
                  data: "id="+id,
                  dataType: "html",
