<?php echo form_open('Pembina/delete');?>
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar Pembina</a>
            <div>
              <a href="<?php base_url(); ?>Pembina/input" class="float-right">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1; foreach ($pembina as $data) {?>
                    <?php $id_check = $data->idpembina;?>
                    <tr>
                        ...
                        <td><?php echo $data->idpembina?></td>
                        <td><?php echo $data->nama_pembina?></td>
                        <td><?php echo $data->telepon?></td>
                        <td><a href="<?php base_url()?>Pembina/edit/<?php echo $id_check;?>">
