      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1; foreach ($approvalprestasiormawa as $data) {?>
                    <?php
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="<?php base_url()?>ApprovalPrestasiOrmawa/data_foto/<?php echo base64_encode($id_check);?>">
                          <b>
                        ...
                        <td>
                          ...
                          -
                           ...
                           ?>
                           <a href="<?php base_url()?>ApprovalPrestasiOrmawa/approveprestasi/<?php echo base64_encode($id_check);?>">
