      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
            ...
            <tbody>
              <?php $no=1; foreach ($historyanggaran as $data) {?>
                ...
                <tr>
                    ...
                    <td><b style="background-color:white;padding:3px;color:black;font-size:12px"><?php echo rupiah($data->anggaran_sisa);?></b></td>
                    ...
                    <td>
                      <a onclick="return confirm('Dana anggaran ormawa akan diaktifkan kembali. Apakah anda yakin ?');" href="<?php base_url()?>HistoryAnggaran/Aktif/<?php echo base64_encode($id_check);?>" >
                      ...
                      <!-- <a href="<?php base_url()?>HistoryAnggaran/detail/<?php echo base64_encode($id_check);?>">
