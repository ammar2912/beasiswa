<?php echo form_open('Jurusan/delete');?>
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar Jurusan</a>
            <div>
              <!-- <a href="<?php base_url(); ?>JurusanPimpinan/input" class="float-right">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1; foreach ($jurusanpimpinan as $data) {?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $no;?></td>
                        <td><?php echo $data->kode_jur?></td>
                        <td><?php echo $data->nama_jurusan?></td>
                        <td>
                          <?php
                           if($data->status == 1){
                           ?>
                           <!-- <a href="<?php base_url()?>Jurusan/NonAktif/<?php echo base64_encode($id_check);?>"> -->
                           <p class="btn btn-success btn-sm">Aktif</p>
                           <!-- </a> -->
                           <?php
                           } else{
                           ?>
                           <!-- <a href="<?php base_url()?>Jurusan/Aktif/<?php echo base64_encode($id_check);?>"> -->
                        ...
                        <!-- <td><a href="<?php base_url()?>Jurusan/edit/<?php echo base64_encode($id_check);?>">
