    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar Approve Kegiatan Mahasiswa</a>
            <div>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
            ...
            <tbody>
              <?php $no=1; foreach ($approvekegiatan as $data) {?>
                <?php
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="bodymodal_acc">
        <?php echo form_open('ApproveKegiatanMahasiswa/approvekegiatan');?>
        Pengajuan : <b id="periode"></b>
        <br>
        <br>
        <div class="row">
          <div class="col-lg-6">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="bodymodal_revisi">
        ...
        <br>
        <?php echo form_open_multipart('ApproveKegiatanMahasiswa/revisikegiatan');?>
        <div class="row">
          <div class="col-lg-12">
