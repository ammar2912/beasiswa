    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Data Proker</a>
            <div>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-striped table-bordered ">
                ...
                <tbody>
                  <?php $no=1; foreach ($dataproker as $data) {?>
                    <?php
                    $id_check = $data->id_prokers;
                    $status_proker = '';
                    ...
                    <tr>
                        ...
                        <td>
                          <?php
                           ...
                           <?php
                         }elseif ($data->status == 0 && $data->status_revisi != 0) { ?>
                        ...
                        <td>
                          <?php if($data->status == 0  && $data->status_revisi != 0){ ?>
                            <a  href="javascript:;"
                      ...
                      <?php }elseif ($data->status == 0) { ?>
                        <a onclick="return confirm('Apakah anda yakin ?');" href="<?php base_url()?>DataProker/delete/<?php echo base64_encode($id_check);?>">
                        <!-- <a> -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="bodymodal_revisi">
        <h5> Proker : <b id="nama_proker"></b></h5>
        <br>
        <?php echo form_open_multipart('DataProker/revisiproker');?>
        <div class="row">
          <div class="col-lg-12">
            <b>Nama Proker : </b><br>
            <input id="id_proker" name="id_proker"  required="1" type="hidden" class="form-control">
            <input id="nama_proker2" name="nama_proker"  required="1" type="text" class="form-control">
          </div>
          <div class="col-lg-12">
            <br>
          ...
          <div class="col-lg-12">
            <br>
            <b>Proposal Proker (Revisi) : <small style="color:red">*Kosongkan jika tidak dirubah, File Hanya PDF</small></b><br>
...
$(document).ready(function() {
  $('#modal_revisi').on('show.bs.modal', function (event) {
    ...
    modal.find('#nama_proker2').attr("value",div.data('nama_proker'));
