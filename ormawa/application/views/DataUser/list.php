<!-- <?php echo form_open('DataUser/delete');?> -->
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Data User</a>
            <div>
              <a href="<?php base_url(); ?>DataUser/input" class="float-right">
                    ...
                    <tr>
                        ...
                        <td>
                          <?php
                           if($data->jabatan == 2){
                           ?>
                           <p class="btn btn-primary btn-md">Kemahasiswaan</p>
                           </a>
                           <?php
                           } else{
                           ?>
                           <p class="btn btn-info btn-md">User Pimpinan</p>
                           </a>
                           <?php
                           }
                           ?>
                        ...
                        <td>
                          <a href="<?php base_url()?>DataUser/edit/<?php echo base64_encode($id_check);?>">
                        ...
                        <a href="<?php base_url()?>DataUser/delete/<?php echo base64_encode($id_check);?>">
