<!-- <?php echo form_open('JenisSurat/delete');?> -->
    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">Daftar Jenis Surat</a>
            <div>
                ...
                <tbody>
                  <?php $no=1; foreach ($jenissurat as $data) {?>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="<?php base_url()?>JenisSurat/edit/<?php echo base64_encode($id_check);?>">
                        ...
                        <?php
                          if($data->status == 1){
                         ?>
                         <a onclick="return confirm('Apakah anda yakin ?');" href="<?php echo base_url()?>JenisSurat/NonAktif/<?php echo base64_encode($id_check);?>">
                           <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Nonaktif Jenis Surat">
                         ...
                         ?>
                         <a onclick="return confirm('Apakah anda yakin ?');" href="<?php echo base_url()?>JenisSurat/Aktif/<?php echo base64_encode($id_check);?>">
                           <button type="button" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Aktifkan Jenis Surat">
                             <i class="fa fa-power-off"></i>
                           </button>
                         </a>
                         <?php
