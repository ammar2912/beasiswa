...
class ModelDataProker extends CI_Model{
  ...
  **/
  ...
  public function get_data($id){
    $this->db->select('tb_proker.*,tb_ormawa.nama_ormawa as nama_ormawa,tb_proker.status as status_proker,tb_proker.id as id_prokers,tb_lampiran_proker.*');
		$this->db->from('tb_proker');
    $this->db->where('tb_proker.id_ormawa',$id);
