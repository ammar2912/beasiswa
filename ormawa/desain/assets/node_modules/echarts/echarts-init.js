...
//             name:'Site C',
//             type:'bar',
//             data:[2.6, 6.0, 3.0, 10.4, 18.7, 50.7, 15.6, 152.2, 28.7, 78.8, 9.0, 10.3],
//             markPoint : {
//                 data : [
//                     {name : 'The highest year', value : 182.2, xAxis: 7, yAxis: 183, symbolSize:18},
//                     {name : 'Year minimum', value : 2.3, xAxis: 11, yAxis: 3}
...
$.ajax({
  type: 'GET',
  url: link+"/Home/get_grafik",
  dataType : 'json',
  async : false,
  success: function(response) {
    // alert(response)
    // grafik(response);
    grafik(response.legend,response.warna,response.data);
  }

});

function grafik(legend,warna,data) {
