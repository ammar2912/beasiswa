<div class="row">
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card"> <img class="card-img" src="<?php echo base_url()?>desain/assets/images/logo_pemkab.png" height="456" alt="Card image">
            <div class="card-img-overlay card-inverse text-white social-profile d-flex justify-content-center">
                <div class="align-self-center"> <img src="<?php echo base_url()?>desain/user.png" class="img-circle" width="100">
                    ...
                    <h4 class="card-title">NIK : <?php echo $pegawai['nik']; ?></h4>
                    <h4 class="card-subtitle text-success"> <b><?php echo @$pegawai['jabatan_sekarang']; ?></b></h4>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
              <small class="text-muted">Alamat E-mail </small><h6><?php echo @$pegawai['email']; ?></h6>
              <small class="text-muted p-t-30 db">Phone</small><h6><?php echo @$pegawai['telepon']; ?></h6>
              <small class="text-muted p-t-30 db">Provinsi</small><h6><?php echo @$this->ModelAlamat->data_provinsi($pegawai['provinsi']); ?></h6>
              <small class="text-muted p-t-30 db">Kota / Kabupaten</small><h6><?php echo @$this->ModelAlamat->data_kabupaten($pegawai['kabupaten']); ?></h6>
              <small class="text-muted p-t-30 db">Alamat</small><h6><?php echo @$pegawai['alamat']?></h6>
    ...
    <div class="col-lg-8 col-xlg-9 col-md-7">
        <div class="card">
            ...
            <ul class="nav nav-tabs profile-tab" role="tablist">
                ...
                <!-- <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#pendidikan" role="tab">Riwayat Pendidikan</a> </li>
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#jabatan" role="tab">Riwayat Jabatan</a> </li> -->
                <!-- <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#account" role="tab">Riwayat Pendidikan</a> </li> -->
