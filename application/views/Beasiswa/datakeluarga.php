        ...
        <div class="container">
          ...
          <div class="d-flex flex-row  mb-3 p-2">            
            ...
            <div class="p-2  border-right">
              ...
              <div class="mb-4">
                <span id="namaayah" class="output-field"><?=$u->nama_ayah?></span>
              </div>
              <div class="mb-4">
                <span id="pekerjaanayah" class="output-field"><?=$u->pekerjaan_ayah?></span>
              </div>
              <div class="mb-4"> 
                <span id="penghasilanayah" class="output-field"><?=$u->penghasilan_ayah?></span>
              </div>
              <div class="mb-4">
                <span id="statusayah" class="output-field"><?=$u->status_ayah?></span>
              </div>
              <div class="mb-4">
                <span id="namaibu" class="output-field"><?=$u->nama_ibu?></span>
              </div>
              <div class="mb-4">
                <span id="pekerjaanibu" class="output-field"><?=$u->pekerjaan_ibu?></span>
              </div>
              <div class="mb-4">
                <span id="penghasilanibu" class="output-field"><?=$u->penghasilan_ibu?></span>
              </div>
              <div class="mb-4">
                <span id="statusibu" class="output-field"><?=$u->status_ibu?></span>
              </div>
              <div class="mb-4">
                <span id="tanggungananak" class="output-field"><?=$u->tanggungan_anak?></span>
              </div>
            </div>
            <div class="text-center" style="position: fixed; top: 600px; left: 600px;">
            <a href="<?= base_url('Beasiswa/editdatakeluargabeasiswa') ?>" class="btn btn-primary">
                        Edit
            </a>
