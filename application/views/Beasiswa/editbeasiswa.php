    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Edit Data Beasiswa</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" action="<?= base_url('DataBeasiswa/update'); ?>" method="post">
              <input type="hidden" name="id" value="<?= $edit_data->id ?>">
                <div class="col-md-6">
                  <label for="inputEmail5" class="form-label">Nama Beasiswa</label>
                  <input type="text" class="form-control" id="inputEmail5" name="nama" value="<?= $edit_data->namabeasiswa ?>">
                </div>
                <div class="col-md-6">
                  <label for="inputPassword5" class="form-label">Penyelenggara</label>
                  <input type="text" class="form-control" id="inputPassword5" name="penyelenggara" value="<?= $edit_data->penyelenggara ?>">
                </div>
                <div class="col-12">
                  <label for="inputAddress5" class="form-label">Deskripsi</label>
                  <textarea class="form-control"  id="floatingTextarea" name="deskripsi" style="height: 100px;"><?= $edit_data->deskripsi ?></textarea>
                </div>
                <div class="col-12">
                  <label for="inputAddress2" class="form-label">Lama Beasiswa</label>
                  <input type="text" class="form-control" id="inputAddress2" name="lamabeasiswa" value="<?= $edit_data->lamabeasiswa ?>">
                </div>
                <div class="col-md-6">
                  <label for="inputEmail5" class="form-label">Tanggal Pendaftaran</label>
                  </br>
                  <input type="date" name="tanggalpendaftaran" value="<?= $edit_data->tanggalpendaftaran ?>">
                </div>
                <div class="col-md-6">
                  <label for="inputPassword5" class="form-label">Tanggal Penutupan</label>
                </br>
                  <input type="date" name="tanggalpenutupan" value="<?= $edit_data->tanggalpenutupan ?>">
                </div>
                <div class="col-12">
                  <label for="inputAddress5" class="form-label">persyaratan</label>
                  <textarea class="form-control"  id="floatingTextarea" name="persyaratan" style="height: 100px;"><?= $edit_data->persyaratan ?></textarea>
                </div>
