...
<head>
  ...
  <title>KEMAHASISWAAN POLIJE</title>
  ...
  <link href="<?php echo base_url()?>desain/assets/node_modules/Magnific-Popup-master/dist/magnific-popup.css" rel="stylesheet">


  <link href="<?php echo base_url()?>desain/dist/css/pages/user-card.css" rel="stylesheet">
  ...
  <link href="<?php echo base_url(); ?>desain/assets/node_modules/dropify/dist/css/dropify.min.css" rel="stylesheet">
  ...
  <!-- steps -->
  <link href="<?php echo base_url(); ?>desain/assets/node_modules/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css" rel="stylesheet">
  <!-- Page plugins css -->
  <link href="<?php echo base_url(); ?>desain/assets/node_modules/clockpicker/dist/jquery-clockpicker.min.css" rel="stylesheet">
  <!-- Color picker plugins css -->
  <link href="<?php echo base_url(); ?>desain/assets/node_modules/jquery-asColorPicker-master/css/asColorPicker.css" rel="stylesheet">
  <!-- Date picker plugins css -->
  <link href="<?php echo base_url(); ?>desain/assets/node_modules/bootstrap-datepicker/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css" />
  <!-- Daterange picker plugins css -->
  <link href="<?php echo base_url(); ?>desain/assets/node_modules/timepicker/bootstrap-timepicker.min.css" rel="stylesheet">
  <link href="<?php echo base_url(); ?>desain/assets/node_modules/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">

  <link href="<?php echo base_url(); ?>desain/dist/css/pages/contact-app-page.css" rel="stylesheet">
  <link href="<?php echo base_url(); ?>desain/dist/css/pages/footable-page.css" rel="stylesheet">
...
<link type="text/css" href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/south-street/jquery-ui.css" rel="stylesheet">
  ...
  <link href="<?php echo base_url(); ?>desain/assets/node_modules/bootstrap-switch/bootstrap-switch.min.css" rel="stylesheet">

  <link href="<?php echo base_url(); ?>desain/dist/css/pages/bootstrap-switch.css" rel="stylesheet">


  <!-- <link href="<?php echo base_url(); ?>desain/assets/mdb.min.css" rel="stylesheet"> -->
  <!-- <link href="<?php echo base_url(); ?>desain/assets/Elearning/style.css" rel="stylesheet"> -->
...
<div id="main-wrapper">
  ...
  <!-- ============================================================== -->
  <header class="topbar">
    <nav class="navbar top-navbar navbar-expand-md navbar-dark blue-gradient">
      <!-- ============================================================== -->
      <!-- Logo -->
      <!-- ============================================================== -->
      <div class="navbar-header">
        <a class="navbar-brand" href="<?php echo base_url() ?>">
          ...
          <!-- Dark Logo icon -->
          <img src="<?php echo base_url(); ?>desain/logo_polije.png" style="max-width: 40px;" alt="homepage" class="dark-logo" />
          <!-- Light Logo icon -->
          <img src="<?php echo base_url(); ?>desain/logo_polije.png" style="max-width: 40px;" alt="homepage" class="light-logo" />
        </b>
        <!--End Logo icon -->
        <span class="hidden-xs" style="font-size: 11px;"><span class="font-bold">KEMAHASISWAAN</span> POLIJE </span>
      </a>
    </div>
    <!-- ============================================================== -     ->
    <!-- End Logo -->
...
<div class="page-wrapper">
  ...
  <div class="container-fluid">
    <?php if (@$this->uri->segment(1) != null || @$this->uri->segment(1) != ""): ?>
    ...
    <?php
    if (@$this->session->flashdata('notifJS')!=null || @$this->session->flashdata('notifJS')!='') {
      $this->load->view("Core/notifJS");
     }?>
...
<script src="<?php echo base_url()?>desain/assets/node_modules/bootstrap-switch/bootstrap-switch.min.js"></script>
<!-- Magnific popup JavaScript -->
<script src="<?php echo base_url()?>desain/assets/node_modules/Magnific-Popup-master/dist/jquery.magnific-popup.min.js"></script>
<script src="<?php echo base_url()?>desain/assets/node_modules/Magnific-Popup-master/dist/jquery.magnific-popup-init.js"></script>
<!-- Tour Bootstrap -->
<script src="<?php echo base_url()?>desain/CoreJS.js"></script>
...
$(document).ready(function() {
    ...
    CKEDITOR.replace('ckeditor', {
        filebrowserUploadUrl: '<?php echo base_url() ?>desain/ckeditor/ck_upload.php',
  ...
  $(document).ready(function () {
    ...
    jQuery('.tahun').datepicker({dateFornat:'yyyy'});
    $('.jam').clockpicker({
        donetext: 'Done',
  ...
  <script src="<?php echo base_url() ?>desain/assets/node_modules/Chart.js/chartjs.init.js"></script>
  <script src="<?php echo base_url() ?>desain/assets/node_modules/Chart.js/Chart.min.js"></script>
  <?php $this->load->view("Home/GrafikMahasiswa"); ?>
</body>
