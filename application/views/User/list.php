        ...
        <div>
            ...
            <div>
              <a href="<?php base_url(); ?>User/input" class="float-right">
                <button type="button" class="btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tambah Data Baru"><i class="fas fa-plus"></i></i></button>
              </a>
            </div>
      </div>
      <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td>
                        ...
                        <button type="button" class="btn btn-warning btn-floating" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-edit"></i></button>
                        </a>
                      </td>
                  </tr>
                <?php $no++;  endforeach; ?>
