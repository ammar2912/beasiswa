...
<h6 class="card-subtitle">Penelitian Terapan | Tahun Pelaksanaan</h6>
<label class=" card-subtitle cyan-text">Judul Penelitian</label>
      ...
      <div class="form-group shadow-textarea col-md-12" >
        ...
        <textarea class="form-control " rows="5" placeholder="tes ringkasan edit ... " name="ringkasan" id="ringkasan" value="<?php echo @$lapkemajuan['ringkasan']; ?>"></textarea>
     </div>
    ...
    <div class="form-group shadow-textarea col-md-12" >
      <label for="tgl_kemajuan"><i class="fas fa-pencil-alt prefix grey-text"></i>Tanggal Kemajuan:</label>
      ...
      <div class="card">
          <div class="card-body">
            <h4 class="card-title">Unggah Dokumen</h4>
                <input type="file" id="file_lk" class="dropify" name="file_lk" data-max-file-size="10M"/>
          </div>
          </div>
    </div>
  <br>
    ...
    <div class="luaran_wajib">
      <h3 for="form107">TAMBAH LUARAN WAJIB</h3>
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="card">
              <div class="card-body">
                <h6 class="card-title">Unggah Dokumen Deskripsi dan Spesifikasi Produk</h6>
                    <input type="file" id="file_dok_deskripsi" class="dropify" name="file_dok_deskripsi" data-max-file-size="1M"/>
          ...
          <div class="card">
              <div class="card-body">
                <h6 class="card-title">Unggah Dokumen Hasil Uji COba produk</h6>
                    <input type="file" id="file_dok_ujicoba" class="dropify" name="file_dok_ujicoba" data-max-file-size="1M"/>
                    <input type="hidden" name="cekfotoktp" value="">
              </div>
              </div>
        </div>
          ...
          <div class="card">
              <div class="card-body">
                <h6 class="card-title">Unggah Dokumentasi Foto Hasil Pengujian Produk</h6>
                    <input type="file" id="file_dok_ujiproduk" class="dropify" name="file_dok_ujiproduk" data-max-file-size="1M"/>
                    <input type="hidden" name="cekfotoktp" value="">
              </div>
              </div>
        </div>
