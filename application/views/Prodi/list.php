    ...
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header aqua-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div>
            ...
            <a href="" class="white-text mx-3">LIST PRODI</a>
            <div>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="myTable" class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                    <?php $no = 1; foreach ($prodi as $value):
                      $id_check = $value->idjurusan;?>
                      <tr>
                        ...
                        <td><?php echo $value->kode_prodi; ?></td>
                        <td><?php echo $value->nama_prodi; ?></td>
                        <td><?php echo $value->nama_jurusan; ?></td>
                          <td>
                            <a href="<?php echo base_url().'Prodi/edit/'.$id_check; ?>">
