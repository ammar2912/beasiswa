        ...
        <?php foreach ($terbaru as $value): ?>
          <div class="item px-2">
            <div class="fh5co_hover_news_img">
              ...
              <div>
                <a href="<?php echo base_url()?>Pengumuman/detail/<?php echo $value->idpengumuman;?>" class="d-block fh5co_small_post_heading"><span class=""><?php echo $value->judul ?></span></a>
