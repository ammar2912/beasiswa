        ...
        <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
          <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">
              <b> TENTANG KEMAHASISWAAN</b>
              <p><?php echo $this->libcore->tgl(date("Y-m-d")) ?></p>
            </div>
          </div>
          <div class="row pb-4" style="text-align: justify;">
        ...
        <?php foreach ($terbaru as $value): ?>
          <div class="item px-2">
            <div class="fh5co_hover_news_img">
              ...
              <div>
                <a href="../Pengumuman/detail/<?php echo $value->idpengumuman ?>"  class="d-block fh5co_small_post_heading"><span class=""><?php echo $value->judul ?></span></a>
