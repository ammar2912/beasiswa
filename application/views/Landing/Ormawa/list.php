    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">ORMAWA</div>
                </div>
                <div class="row pb-4">
                  <?php foreach ($data as $value): ?>
                    ...
                    <div class="col-md-12 animate-box">
                        <a href="#" class="fh5co_magna py-2"> <?php echo $value->nama_ormawa; ?>  </a>
                        <hr>
            ...
            <!-- <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="<?php echo base_url() ?>desain/landing/berita/images/download (1).jpg" alt="img" class="fh5co_most_trading"/>
                    </div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="<?php echo base_url() ?>desain/landing/berita/images/allef-vinicius-108153.jpg" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="<?php echo base_url() ?>desain/landing/berita/images/download (2).jpg" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.</div>
                        <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center"><img src="<?php echo base_url() ?>desain/landing/berita/images/seth-doyle-133175.jpg" alt="img"
        ...
        <div class="row mx-0">
            <div class="col-12 text-center pb-4 pt-4">
                ...
                if ($page > 0): ?>
                  <a href="<?php echo base_url("OrmawaData/page/").($page-1) ?>" class="btn_mange_pagging"><i class="fa fa-long-arrow-left"></i>&nbsp;&nbsp; Previous</a>
                <?php endif; ?>
                <?php if ($page < $limit_page): ?>
                  <a href="<?php echo base_url("OrmawaData/page/").($page+1) ?>" class="btn_mange_pagging">Next <i class="fa fa-long-arrow-right"></i>&nbsp;&nbsp; </a>
                <?php endif; ?>
             </div>
        </div>
    </div>
