    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">KOMITE ETIK DI KEMAHASISWAAN POLIJE</div>
                </div>
                <div class="row pb-4">
                  <?php foreach ($data as $value): ?>
                    ...
                    <div class="col-md-7 animate-box">
                        <a href="KomiteEtik/detail/<?php echo $value->idkomite_etik ?>" class="fh5co_magna py-2"> <?php echo $value->judul; ?>  </a>
