    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Layanan Kemahasiswaan </div>
                </div>
                          ...
                          <tbody>
                            ...
                            foreach ($data as $value): ?>
                              <tr>
                                ...
                                <td class="text-center"> <a href="<?php echo base_url().$value->dokumen ?>"> Download</a></td>
                                <td class="text-center"> <a href="<?php echo base_url('LayananKemahasiswaan/detail/').$value->idlayanan_kemahasiswaan ?>" class="main-button">Selengkapnya</a></td>
                              </tr>
                              <?php $no++; endforeach; ?>
                          </tbody>
                      </table>
