<div class="row form-group">
      ...
      <div class="col-12 col-md-9">
          <input type="text" name="judul" id="judul" class="form-control" placeholder="judul" value="<?php echo @$penelitian['judul']; ?>" >
      </div>
</div>
<div class="row form-group">
      <div class="col col-md-3">
      ...
      <div class="col-12 col-md-9">
          <input type="text" name="program" id="program" class="form-control" placeholder="program" value="<?php echo @$penelitian['program']; ?>" >
      </div>
</div>
<div class="row form-group">
      <div class="col col-md-3">
        <label for="text-input" class=" form-control-label">Lama Waktu Pelaksanaan </label>
      </div>
      <div class="col-12 col-md-9">
          <input type="text" name="tahun_pelaksanaan" id="tahun_pelaksanaan" class="form-control" placeholder="Lama Waktu Pelaksanaan" value="<?php echo @$penelitian['tahun_pelaksanaan']; ?>" >
      </div>
</div>
<div class="row form-group">
      <div class="col col-md-3">
