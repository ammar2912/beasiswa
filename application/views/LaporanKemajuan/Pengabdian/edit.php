...
<div class="row">
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      ...
      <div class="card-body">
        <?php echo form_open_multipart('LaporanKemajuanPengabdian/update');?>
        <h4 class="card-title">Laporan Kemajuan</h4>
        <h6 class="card-subtitle">Pengabdian Terapan | Tahun Pelaksanaan <?php echo $pengabdian->tahun_pelaksanaan ?>
          <br>
          Tahun Ke <?php echo date("Y")-date("Y", strtotime($pengabdian->tanggal_awal)) ?> dari <?php echo date("Y", strtotime($pengabdian->tanggal_sampai))-date("Y", strtotime($pengabdian->tanggal_awal))  ?> Tahun
        </h6>
        <label class=" card-subtitle cyan-text">Judul Pengabdian : <?php echo $pengabdian->judul ?></label>

              <input type="hidden" name="idlaporan" value="<?php echo @$lapkemajuan['idlaporan_kemajuan_pengabdian'] ?>">
              <input type="hidden" name="idluaran" value="<?php echo @$luaran['idluaran_wajib_pengabdian']?>">
            ...
            <div class="col-lg-6 col-md-6" style="top: 5px;">
              <div class="card">
                  <div class="card-body">
                    ...
                    <label class="control-label"><a href="<?php echo base_url().@$lapkemajuan['file_lp'] ?>"><i class="fa fa-download"></i> Download</a> </label>
                        <input type="file" id="file_lk" class="dropify" name="file_lk" data-max-file-size="10M" data-default-file="<?php echo base_url(@$lapkemajuan['file_lp']) ?>"/>
                  </div>
                  </div>
            </div>
          <br>
