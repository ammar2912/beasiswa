...
<?php echo form_open('pengabdian/delete');
  ...
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header aqua-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div></div>
            <a href="" class="white-text mx-3">LAPORAN KEMAJUAN PENGABDIAN</a>
            <div>
              <?php
              // if ($_SESSION['jabatan'] == "dosen" && $this->Core->cekJadwal()):
              if ($_SESSION['jabatan'] == "dosen"):
                ?>
                <a href="<?php echo base_url(); ?>LaporanKemajuanPengabdian/input/<?php echo $this->uri->segment(3) ?>" class="float-right">
      ...
      <div class="card-body">
        <div class="row p-t-20">
            <div class="col-md-12">
              <h6 class="card-subtitle"><b>pengabdian Terapan | Tahun Pelaksanaan <?php echo $pengabdian->tahun_pelaksanaan ?></b>
                <br>
              ...
              <label class=" card-subtitle cyan-text"><h5>Judul pengabdian : <?php echo $pengabdian->judul ?></h5></label>
            </div>
          <div class="col-md-3">
            <div class="form-group animated flipIn">
              ...
              <div class="input-group">
                ...
                <select name="tahun" id="tahun" class="mdb-select colorful-select dropdown-info sm-form">
                  <?php for ($i=date("Y", strtotime($pengabdian->tanggal_awal)); $i < (date("Y") + 5); $i++) { ?>
...
$( document ).ready(function() {
  ...
  function getData() {
    ...
    $.ajax({
          type: "POST",
          url: "<?php echo base_url() ?>LaporanKemajuanPengabdian/dataLaporan",
