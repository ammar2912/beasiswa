  ...
  <div class="col-12">
    <div class="card card-cascade narrower z-depth-1">
      <div class="view view-cascade gradient-card-header aqua-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        <div></div>
            <a href="" class="white-text mx-3">LAPORAN PENELITIAN AKHIR</a>
            <div>
            </div>
      </div>
      <div class="card-body">
...
$( document ).ready(function() {
  ...
  function getData() {
    ...
    $.ajax({
          type: "POST",
          url: "<?php echo base_url() ?>LaporanDosen/getLaporanPenelitianakAkhir",
    ...
    $.ajax({
          type: "POST",
          url: "<?php echo base_url() ?>LaporanDosen/getRekapLaporanPenelitianAkhir",
          data: {awal:awal, akhir:akhir},
          success: function(data){
            // alert(data);
            $("#laporan").html(data);
