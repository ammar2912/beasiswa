...
<head>
  <meta charset="UTF-8">
  <title>SELAMAT DATANG AKBID JEMBER</title>
  <meta charset="utf-8">
...
<body>
      ...
      <div class="login-form animated fadeInDown delay-0.5s">
        ...
        <div id="login-form">
          <div class="head">
            <img src="<?php echo base_url() ?>desain/assets/images/logo_akbid.png"/>
          </div>
        <form id="FormLogin">
          <?php echo @$this->session->flashdata("alert") ?>
          <h5 class="badge-username"><span class="badge badge-danger">Username Anda Tidak Ditemukan / Anda Belum Melakukan Verifikasi</span></h5>
          <li class="username">
          ...
          <h5 class="badge-password"><span class="badge badge-danger">Maaf Tanggal Lahir Anda Salah</span></h5>
          <li class="password">
            <input type="date" id="password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}"><i href="#" class=" icon lock"></i>
          </li>
