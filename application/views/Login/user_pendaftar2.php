...
<body style="background-color: #666666;">
	...
	<div class="limiter">
        ...
        <div class="loader animated flipInX" style="display:none;">
          ...
          <h6 class="badge-username"><span class="badge badge-danger">Username Anda Tidak Ditemukan / Anda Belum Melakukan Verifikasi</span></h6>
          ...
          <h6 class="badge-password"><span class="badge badge-danger">Maaf Tanggal Lahir Anda Salah</span></h6>
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<input class="input100" type="date" name="password" value="2000-01-01" id="password" >
						<span class="focus-input100"></span>
				...
				<!-- <div class="login100-more" style="background-image: url('<?php echo base_url()?>desain/Login_baru/images/bg-01.jpg');"> -->
				<div class="login100-more" style="background-image: url('<?php echo base_url()?>desain/kampusakbid.jpg');">
				</div>
			</div>
		</div>
	</div>
...
<!--===============================================================================================-->
  ...
  $(document).ready(function(e){
    $("#FormLogin").on('submit', function(e){
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>index.php/Login/aksi_user_pendaftar',
