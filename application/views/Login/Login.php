...
<head>
  <meta charset="UTF-8">
  <title>SELAMAT DATANG DI KEMAHASISWAAN POLIJE</title>
  <meta charset="utf-8">
...
<body style="background-image:url(<?php echo base_url()?>desain/gedung-a3-polije.jpg); background-size: cover; ">
      ...
      <div class="login-form animated fadeInDown delay-0.5s">
        ...
        <div id="login-form">
          ...
          <div class="head">
            <img src="<?php echo base_url() ?>desain/logo_polije.png"/>
          </div>
        <form id="FormLogin">
