...
<div class="page-wrapper" style="margin-left:0px;padding-left:50px;">
  <div class="row mt-3">
    <div class="col-md-8 blue-gradient" style="min-height:500px;color:white;"><center><h1 class="mt-2">Antrian Loket</h1></center><center><h1 style="font-size:300px;">000</h1></center></div>
    <div class="col-md-4" style="padding-left:20px;color:white;text-align:right;">
      <div class="row col-md-12 purple-gradient">
      <center><h1 class="antrian_poliumum" style="margin-left:10px;font-size:65px;"><?php echo str_pad($antrian['UMU'],3,"0",STR_PAD_LEFT)?></h1></center>
      <p style="font-size:20px;margin-left:30px">Poli Umum</p>
      </div>
      <div class="row col-md-12 purple-gradient mt-3">
      <center><h1 class="antrian_poliozon" style="margin-left:10px;font-size:65px;"><?php echo str_pad($antrian['OZO'],3,"0",STR_PAD_LEFT)?></h1></center>
      <p style="font-size:20px;margin-left:30px">Poli Ozon</p>
      </div>
      <div class="row col-md-12 purple-gradient mt-3">
      <center><h1 class="antrian_poliobgyn" style="margin-left:10px;font-size:65px;"><?php echo str_pad($antrian['OBG'],3,"0",STR_PAD_LEFT)?></h1></center>
      <p style="font-size:20px;margin-left:30px">Poli Obgyn</p>
      </div>
      <div class="row col-md-12 purple-gradient mt-3">
      <center><h1 class="antrian_poliinternis" style="margin-left:10px;font-size:65px;"><?php echo str_pad($antrian['INTERNIS'],3,"0",STR_PAD_LEFT)?></h1></center>
      <p style="font-size:20px;margin-left:30px">Poli Internis</p>
      </div>
      <div class="row col-md-12 purple-gradient mt-3">
      <h1 class="antrian_poligigi" style="margin-left:10px;text-align: right;font-size:65px;"><?php echo str_pad($antrian['GIG'],3,"0",STR_PAD_LEFT)?></h1>
